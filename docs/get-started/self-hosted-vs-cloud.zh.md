...
Cloud 的托管供应商网络让你无需注册上游账号或存储 API 密钥即可发起模型请求。目前对应 [托管模型](/docs/get-started/managed-models)——一个账户，按 token 计费，开放模型价格低于官方定价。托管工具与 Agent 已在路线图上。
...
- **使用 Cloud 托管模型** — 参阅 [托管模型](/docs/get-started/managed-models)，了解模型目录、定价及如何发起第一个托管请求。
