...
| `references/mcp-memory.md` | Walrus Memory upstream + per-agent namespace scoping (`plugins.bitrouter-memory`, `x-bitrouter-agent` header) + always-on memory (`always:` block: forced recall + instructed remember) |
